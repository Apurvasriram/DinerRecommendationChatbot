...
#def getQueueURL():
   ...
   # q = SQS.get_queue_url(QueueName='DiningChatbot').get('QueueUrl')
    #return q
...
def record(event):
    ...
    try:
        ...
        u = "https://sqs.us-east-1.amazonaws.com/276240606154/DiningChatbot"
...
def validate_dining_suggestion(location, cuisine, time, date, numberOfPeople, phoneNumber):
    ...
    # if numberOfPeople is not None and numberOfPeople.isnumeric() and numberOfPeople>20:
        return build_validation_result(False,
                                       'NumberOfPeople',
...
def diningSuggestions(intent_request,context):
    ...
    # In a real bot, this would likely involve a call to a backend service.
        ...
        logger.debug("Inside Fullfillmen")
        sqs = boto3.client("sqs",region_name="us-east-1")
        #response = sqs.get_queue_url(QueueName='DiningChatbot')
        logger.debug("After getting sqs url as response")
        queue_url = "https://sqs.us-east-1.amazonaws.com/276240606154/DiningChatbot"
